...
import projectsBg from "../assets/industry.jpg";

const upcomingProjects = [
  { icon: "💡", title: "LED Plant", location: "Gujarat", investment: "₹1.5 Cr" },
  { icon: "👕", title: "Garment Unit", location: "Kolkata", investment: "₹1.2 Cr" },
  { icon: "🌾", title: "Flour Mill", location: "Punjab", investment: "₹80 Lacs" },
  { icon: "💧", title: "Alkaline Water Plant", location: "Jhansi & Chhapra", investment: "₹30 Lacs" },
  { icon: "🍽️", title: "Frozen Foods", location: "Kashipur", investment: "₹10 Lacs" },
];

const UpcomingProjectsTimeline = () => {
  return (
    <div
    ...
    >
      ...
      >
        <h2 className="text-4xl md:text-5xl font-extrabold mb-2 drop-shadow-lg">
          UPCOMING <span className="text-amber-400">PROJECTS</span>
        </h2>
      ...
      {/* Timeline */}
      <div className="relative z-10 w-full max-w-4xl flex flex-col md:flex-row md:justify-between">
        ...
        {upcomingProjects.map((proj, idx) => (
          ...
          >
            ...
            >
              <h3 className="text-white text-xl md:text-2xl font-bold">{proj.title}</h3>
              <p className="text-gray-300">{proj.location}</p>
              <p className="text-amber-400 font-semibold mt-1">{proj.investment}</p>
            </motion.div>
          </motion.div>
        ))}
      </div>

      {/* Spotlight behind timeline */}
...
export default UpcomingProjectsTimeline;
